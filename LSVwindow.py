...
class Ui_LSV(object):
    ...
    def setupLSV(self, LSV, hid):
        ...
        LSV.resize(1200, 850)
        LSV.setMinimumSize(QtCore.QSize(1200, 850))
        LSV.setMaximumSize(QtCore.QSize(1200, 850))
        icon = QtGui.QIcon()
    ...
    def StopPlot(self):
        ...
        self.MplWidget.canvas.axes.legend(['Linear Sweep Voltammetry'], loc='upper right')
    ...
    def retranslateUi(self, LSV):
        ...
        LSV.setWindowTitle(_translate("LSV", "LSV"))
        ...
        self.label_3.setText(_translate("CV", "3"))

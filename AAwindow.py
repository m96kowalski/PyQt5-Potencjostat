...
class Ui_AMPERO(object):
    ...
    def AddDataToLists(self, DataStr):
        ...
        str = "{:.2f};{:.2f};{:.2f};{:.2f}".format(Pierwsza, Druga, Trzecia, Czwarta)
    ...
    def setupAMPERO(self, AMPERO, hid):
        ...
        AMPERO.setObjectName("AMPERO")
        AMPERO.resize(1200, 850)
        AMPERO.setMinimumSize(QtCore.QSize(1200, 850))
        AMPERO.setMaximumSize(QtCore.QSize(1200, 850))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        AMPERO.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(AMPERO)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBoxPROPERTIESv2 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBoxPROPERTIESv2.setGeometry(QtCore.QRect(10, 0, 371, 161))
        font = QtGui.QFont()
        ...
        self.label_REVERSE_SCAN.setGeometry(QtCore.QRect(10, 90, 121, 20))
        ...
        self.pushButtonCV_Properties.setGeometry(QtCore.QRect(160, 170, 221, 81))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        AMPERO.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(AMPERO)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1200, 26))
        self.menubar.setObjectName("menubar")
        AMPERO.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(AMPERO)
        self.statusbar.setObjectName("statusbar")
        AMPERO.setStatusBar(self.statusbar)

        self.retranslateUi(AMPERO)
        ...
        QtCore.QMetaObject.connectSlotsByName(AMPERO)
    ...
    def StopPlot(self):
        ...
        self.MplWidget.canvas.axes.legend(['Amperometry'], loc='upper right')
    ...
    def retranslateUi(self, AMPERO):
        _translate = QtCore.QCoreApplication.translate
        AMPERO.setWindowTitle(_translate("AMPERO", "AMPERO"))
        self.groupBoxPROPERTIESv2.setTitle(_translate("CV", "Properties:"))
        self.label_SCAN_Ewe.setText(_translate("CV", "NumData"))
        self.Propert_.setText(_translate("CV", "0"))
        self.label_V_vs_2.setText(_translate("CV", "[-]"))
        self.label_REVERSE_SCAN.setText(_translate("CV", "RE-SE Voltage"))
        self.label_TO_VERTEX_E1.setText(_translate("CV", "Sample Period"))
        self.label_REPEAT_nc.setText(_translate("CV", "SE Voltage "))
        self.label_REPEAT_TIME.setText(_translate("CV", "[mV]"))
        self.label_V_vs_4.setText(_translate("CV", "[Hz]"))
        self.label_V_vs_3.setText(_translate("CV", "[mV]"))
        self.Propert_1.setText(_translate("CV", "0,00"))
        self.Propert_2.setText(_translate("CV", "0,00"))
        self.Propert_3.setText(_translate("CV", "0,00"))
        ...
        self.label_2.setText(_translate("CV", "6"))
        self.label_3.setText(_translate("CV", "6"))

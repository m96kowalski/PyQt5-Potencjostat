...
class Ui_SWV(object):
    ...
    def setupSWV(self, SWV, hid):
        def CloseLocalWindow():
            hid.Close()
            self.Frame_bytes_series.clear()
            self.Frame_converted_series.clear()
            SWV.close()
        SWV.setObjectName("SWV")
        SWV.resize(1200, 850)
        SWV.setMinimumSize(QtCore.QSize(1200, 850))
        SWV.setMaximumSize(QtCore.QSize(1200, 850))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SWV.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(SWV)
        ...
        SWV.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(SWV)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1200, 26))
        self.menubar.setObjectName("menubar")
        SWV.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(SWV)
        self.statusbar.setObjectName("statusbar")
        SWV.setStatusBar(self.statusbar)

        self.retranslateUi(SWV)
        ...
        QtCore.QMetaObject.connectSlotsByName(SWV)
    ...
    def StopPlot(self):
        ...
        self.MplWidget.canvas.axes.legend(['Square Wave Voltammetry'], loc='upper right')
    ...
    def plot_graph(self):
        self.MplWidget.canvas.axes.clear()
        self.MplWidget.canvas.axes.plot(self.Plot_Xseries, self.Plot_Yseries, color='green', linestyle='dashed', marker='o',
    ...
    def retranslateUi(self, SWV):
        _translate = QtCore.QCoreApplication.translate
        SWV.setWindowTitle(_translate("SWV", "SWV"))
        self.groupBoxPROPERTIESv2.setTitle(_translate("CV", "Properties:"))
        self.label_SCAN_Ewe.setText(_translate("CV", "Ramp Start Volt"))
        self.label_AVERAGE_N.setText(_translate("CV", "Amplitude"))
        self.label_VOLTAGE_STEPS.setText(_translate("CV", "[mV]"))
        self.Propert_.setText(_translate("CV", "-1400"))
        self.label_V_vs_2.setText(_translate("CV", "[mV]"))
        self.label_REVERSE_SCAN.setText(_translate("CV", "Vzero Start"))
        self.label_STEP_DURATION.setText(_translate("CV", "[Hz]"))
        ...
        self.label_OVER_LAST.setText(_translate("CV", "Freq"))
        self.label_AVERAGE_N_2.setText(_translate("CV", "Sample Deley"))
        ...
        self.label_AVERAGE_N_3.setText(_translate("CV", "Increment"))
        self.label_VOLTAGE_STEPS_3.setText(_translate("CV", "[mV]"))
        self.Propert_1.setText(_translate("CV", "-500"))
        self.Propert_2.setText(_translate("CV", "1700"))
        self.Propert_3.setText(_translate("CV", "1700"))
        self.Propert_4.setText(_translate("CV", "25"))
        self.Propert_5.setText(_translate("CV", "50"))
        self.Propert_6.setText(_translate("CV", "10"))
        self.Propert_7.setText(_translate("CV", "5"))
        ...
        self.label_3.setText(_translate("CV", "5"))
